...
/**
 * AdminLogin class.
 * AdminLogin is the data structure for keeping
...
class AdminLogin extends CFormModel
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'shortSession'=>Yii::t('Front', 'remember me'),
		);
	}
	...
	public function authenticate($attribute, $params)
	{
		if(!$this->hasErrors())
		{
			...
			$this->_identity=new AUserIdentity($this->login,md5($this->password));
			if(!$this->_identity->authenticate()){
//				if($this->_identity->errorCode == APUserIdentity::USER_IS_NOT_ACTIVE){
