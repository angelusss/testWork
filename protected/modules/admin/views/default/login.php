...
<!--	<a href="index.php"><img src="--><?php //echo Yii::app()->getBaseUrl(true); ?><!--/images/main_logo.png" alt="Logo" class="brand" /></a>-->
	<div class="panel panel-primary admin_panel_login">
		<div class="panel-body">
			<h4 class="text-center" style="margin-bottom: 25px;"><?php echo Yii::t('admin_panel', 'Please Log in');?></h4>
				<?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    <input type="submit" class="btn btn-primary btn-block" value="<?= Yii::t('admin_panel', 'Login'); ?>"/>
				<?php $this->endWidget(); ?>
		</div>
